...
def main():
    ...
    parser.add_argument('--lr', dest='lr', type=float, default=1e-5, help='initial gen learning rate for adam')
    ...
    parser.add_argument('--result_path', dest='result_path', default='/data/ZZJ/code/1101/zzj/train_taihe_finetune_result/',
    ...
    train_data_path = os.path.join(args.dataset_dir, 'process/Training')
    ...
    for epoch in range(args.epoch):
        ...
        for sub in subs:
            ...
            for iteration, batch in enumerate(train_loader):
                ...
                # print('---------------------------')
                # print('MR_images size',MR_images.shape)
